...
// // double powerMethod(Matrix A, Matrix X, int originalRows, int originalCols, int iterationNum ){
...
//   SGData xSub_counts =  getSGCounts(original.rows, original.cols, worldSize);
//   for(int i =0; i< worldSize ;i++){
//     xSub_counts.cnts[i] = xSub_counts.cnts[i] / original.rows;
//     xSub_counts.displs[i] = xSub_counts.displs[i] / original.rows;
